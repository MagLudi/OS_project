 ...
 * 
 * Last revised 6:49 PM 4-Apr-2017
 */
...
void flexTimer0Action(){
	clockInMill += 1;
}

void flexTimerSetClock(uint32_t hi32, uint32_t low32){
	clockInMill = (((uint64_t) hi32) << 32) | ((uint64_t) low32);
}
uint32_t flexTimerGetClockHi(){
	return ((uint32_t) (clockInMill >> 32));
}
uint32_t flexTimerGetClockLow(){
	return ((uint32_t) clockInMill);
}
