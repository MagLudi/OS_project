...
/* globals added for ps3 to track the status of the LEDs*/
bool orangeOn;
bool yellowOn;
bool greenOn;
bool blueOn;
...
/* Routine to return the status of the orange LED. Returns true if on. */
bool ledOrangeStat(void){
	return orangeOn;
}
/* Routine to return the status of the yellow LED. Returns true if on. */
bool ledYellowStat(void){
	return yellowOn;
}
/* Routine to return the status of the green LED. Returns true if on. */
bool ledGreenStat(void){
	return greenOn;
}
/* Routine to return the status of the blue LED. Returns true if on. */
bool ledBlueStat(void){
	return blueOn;
}
